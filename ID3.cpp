...
public:
	...
	void validate()
	{
		...
		// printf("ones in output %d ones in target %d\n",c,c1);
		mismatches = cnt;
...
int main()
{
	...
	// instantiate ID3 class
	ID3 id3(DATASIZE,NUMATTR,TDATASIZE);

	// load training data and train on that data
	loadAllData(1);
	id3.train();
